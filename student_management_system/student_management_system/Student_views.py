...
from myschool.models import Student,Student_Notification,Student_Feedback,Student_leave,Subject,Attendance,Attendance_Report,StudentResult
...
def STUDENT_VIEW_ATTENDANCE(request):
    student  = Student.objects.get(admin = request.user.id)
    subjects = Subject.objects.filter(classes = student.class_id)
